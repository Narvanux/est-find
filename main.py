...
def handle_args():
    ...
    parser.add_argument('-p', '--prompt', action='store_true', help='manage search query via interactive prompt', default=False)
    ...
    parser.add_argument('-sf', '--short-forms', action='store_true', help='display 3 forms of the word', default=False)
